package com.Inmarit.account.modelTest;
...
public class UserTest {
    ...
    public static final String EXPECTED_USERNAME = "gopinadh243p";
    public static final String EXPECTED_PASSWD = "gopinadh243p";
    ...
    public void setUp() throws Exception {
        ...
        user = new User();
        user.setId(1L);
        user.setUsername("gopinadh243p");
        user.setPassword("gopinadh243p");
