...
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <div class="container w3-padding-32" id="about">
    ...
    <div class="w3-content" style="max-width:700px">
	    <p style="text-align:justify;">Inmar develops technology and uses advanced data analytics to make commerce work smarter. </p>
	    <p><strong>Address:</strong> Plot no. 168/1, Road no. 13/A, Jubilee Hills, Hyderabad, Telangana 500033 </p> 
	    <p><strong>Ph No: </strong>  (800) 765-1277 </p>
		<p><strong>E-Mail ID :</strong>  satishgudey4@gmail.com</p>
  	</div>
   </div>
...
<footer class="w3-center  w3-padding-16" style="background-color:#1C3B47 ">
  <p style="color:#FFFFFF ">Copyright @2017 <a href="#"  target="_blank" class="w3-hover-text-green"> Inmar.com</a></p>
</footer>
